...
{
    public DiceStationRecipe(String group, Ingredient ingredient, ItemStack result)
    {
        super(FantasyDice.DICE_STATION_RECIPE_TYPE.value(), FantasyDice.DICE_STATION_RECIPE_SERIALIZER.value(), group, ingredient, result);
    }
